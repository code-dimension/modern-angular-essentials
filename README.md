# Modern Angular Essentials Suite 🚀

[![Marketplace Version](https://img.shields.io/visual-studio-marketplace/v/codedimension.cd-angular-essentials-suite.svg?style=for-the-badge&color=e03e2f)](https://marketplace.visualstudio.com/items?itemName=codedimension.cd-angular-essentials-suite)
[![Installs](https://img.shields.io/visual-studio-marketplace/i/codedimension.cd-angular-essentials-suite.svg?style=for-the-badge&color=0f172a)](https://marketplace.visualstudio.com/items?itemName=codedimension.cd-angular-essentials-suite)
[![Open VSX](https://img.shields.io/open-vsx/v/codedimension/cd-angular-essentials-suite?style=for-the-badge&color=4c1d95)](https://open-vsx.org/extension/codedimension/cd-angular-essentials-suite)
...
3. Search for `codedimension.cd-angular-essentials-suite`.
4. Click **Install**.

### Option 2: Command Line
```bash
code --install-extension codedimension.cd-angular-essentials-suite
```
...
3. Select **Install from VSIX...** and choose the `cd-angular-essentials-suite-1.0.1.vsix` file.
...
3. Publish:
```bash
   npx ovsx publish cd-angular-essentials-suite-1.0.1.vsix
```
